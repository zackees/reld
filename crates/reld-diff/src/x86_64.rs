...
use reld_reloc::elf::x86_64_rel_type_to_string;
use reld_reloc::utils::u32_from_slice;
use reld_reloc::x86_64::RelaxationKind;
use std::fmt::Display;
...
impl Arch for X86_64 {
    ...
    type RelaxationKind = reld_reloc::x86_64::RelaxationKind;
    ...
    ) -> reld_reloc::relaxation::RelocationModifier {
    ...
    fn relocation_to_pc_offset(relocation_info: &RelocationKindInfo) -> u64 {
        ...
        if let reld_reloc::elf::RelocationSize::ByteSize(b) = relocation_info.size {
            b as u64
        } else {
            0
        }
...
impl crate::arch::RType for RType {
    ...
    fn opt_relocation_info(self) -> Option<RelocationKindInfo> {
        reld_reloc::x86_64::relocation_from_raw(self.0)
    }
