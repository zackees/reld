...
pub(crate) enum SymbolPlacement<'data, P: Platform> {
    ...
    #[allow(dead_code)] // Phase 3 COFF synthesized symbols use this generic placement.
...
pub(crate) enum SegmentName {
    ...
    Data,
    Bss,
    /// Any segment name not in the known set. Reld has no `-T` override for
...
impl<'data, P: Platform> Prelude<'data, P> {
    ...
    #[allow(dead_code)] // Phase 3 COFF symbol synthesis reads definitions back from the prelude.
...
impl<'data, P: Platform> InternalSymbolsBuilder<'data, P> {
    ...
    #[allow(dead_code)] // Phase 3 COFF synthesized symbols use this builder entry point.
