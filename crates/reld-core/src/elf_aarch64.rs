...
use reld_reloc::aarch64::RelaxationKind;
use reld_reloc::aarch64::relocation_type_from_raw;
use reld_reloc::elf::AArch64Instruction;
use reld_reloc::elf::DynamicRelocationKind;
use reld_reloc::elf::PAGE_MASK_4KB;
use reld_reloc::elf::RelocationKind;
use reld_reloc::elf::RelocationKindInfo;
use reld_reloc::elf::SIZE_4KB;
use reld_reloc::elf::aarch64_rel_type_to_string;
...
impl crate::platform::Arch for ElfAArch64 {
    ...
    fn relocation_from_raw(r_type: object::elf::RelocationType) -> Result<RelocationKindInfo> {
        reld_reloc::aarch64::relocation_type_from_raw(r_type).ok_or_else(|| {
            error!(
    ...
    fn new_relaxation(
        ...
        _relax_deltas: Option<&reld_reloc::relaxation::SectionRelaxDeltas>,
