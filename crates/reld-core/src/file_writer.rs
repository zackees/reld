    ...
    pub(crate) fn new(
        ...
        Output {
            ...
            config: OutputConfig {
                ...
                fallocate_output_file: args.common().fallocate_output_file,
    ...
    fn new<F: FileSystem<Output = O>>(
        ...
        let output = file_system.create_output(
            ...
            OutputOptions {
                ...
                fallocate_output_file: output_config.fallocate_output_file,
...
fn write_layout<P: Platform>(layout: &Layout<P>, file_system: &impl FileSystem) -> Result {
    let layout_path = reld_layout_schema::layout_path(layout.args().output());
