...
impl<'data, P: Platform> SymbolDb<'data, P> {
    ...
    #[allow(dead_code)] // Phase 3 COFF resolves platform-specific prelude definitions.
...
pub(crate) fn linker_plugin_disabled_error() -> Error {
    error!("Reld was compiled without linker-plugin support, but LTO inputs were detected")
}
