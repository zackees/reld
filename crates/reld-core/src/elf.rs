...
use rayon::Scope;
use rayon::prelude::*;
use reld_reloc::elf::PageMask;
use reld_reloc::elf::RISCV_ATTRIBUTE_VENDOR_NAME;
use reld_reloc::elf::RelocationKind;
use reld_reloc::elf::SectionFlags;
use reld_reloc::elf::SectionType;
use reld_reloc::elf::SegmentFlags;
use reld_reloc::elf::SegmentType;
use reld_reloc::elf::pf;
use reld_reloc::elf::pt;
use reld_reloc::elf::riscvattr::TAG_RISCV_ARCH;
use reld_reloc::elf::riscvattr::TAG_RISCV_ATOMIC_ABI;
...
use reld_reloc::elf::riscvattr::TAG_RISCV_X3_REG_USAGE;
...
use reld_reloc::utils::read_string;
use reld_reloc::utils::read_u32;
use reld_reloc::utils::read_uleb128;
...
impl platform::Platform for Elf {
    ...
    fn will_emit_section_symbol_for_partial_objects(
        ...
        let segment_type = section_id
            ...
            .unwrap_or(reld_reloc::elf::pt::LOAD);
        if section_attr.is_null() {
            ...
            !type_id.is_rela()
                ...
                && !type_id.is_symtab()
                && !type_id.is_strtab()
                && segment_type == reld_reloc::elf::pt::LOAD
        }
    }
...
fn decompress_into(
    ...
    match compression.ch_type.get(LittleEndian) {
        ...
        object::elf::ELFCOMPRESS_ZSTD => {
            ...
            {
                bail!("reld was compiled without zstd support");
            }
        }
...
struct ClassifiedSymbolRelocation {
    ...
    rel_kind: reld_reloc::elf::RelocationKind,
