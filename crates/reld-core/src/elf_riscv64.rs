...
use reld_reloc::elf::RiscVInstruction;
use reld_reloc::elf::riscv64_rel_type_to_string;
use reld_reloc::elf::shf;
use reld_reloc::relaxation::RelocationModifier;
use reld_reloc::relaxation::SectionRelaxDeltas;
use reld_reloc::riscv64::JAL_RANGE;
use reld_reloc::riscv64::RelaxationKind;
use reld_reloc::riscv64::distance_fits_jal;
use reld_reloc::riscv64::relocation_type_from_raw;
...
impl crate::platform::Arch for ElfRiscV64 {
    ...
    fn relocation_from_raw(r_type: object::elf::RelocationType) -> Result<RelocationKindInfo> {
        reld_reloc::riscv64::relocation_type_from_raw(r_type).ok_or_else(|| {
            error!(
    ...
    fn new_relaxation(
        ...
        section_flags: reld_reloc::elf::SectionFlags,
