...
fn setup_argument_parser() -> ArgumentParser<ElfArgs> {
    ...
    parser
        ...
        .execute(|_args, _modifier_stack| {
            ...
            writeln!(stdout, "reld: supported targets: {SUPPORTED_TARGETS}")?;
            writeln!(stdout, "reld: supported emulations: {SUPPORTED_EMULATIONS}")?;
