...
use reld_reloc::elf::SIZE_2KB;
use reld_reloc::elf::loongarch64_rel_type_to_string;
use reld_reloc::elf::shf;
use reld_reloc::loongarch64::RelaxationKind;
use reld_reloc::relaxation::RelocationModifier;
use reld_reloc::utils::or_from_slice;
...
impl crate::platform::Arch for ElfLoongArch64 {
    ...
    fn relocation_from_raw(r_type: object::elf::RelocationType) -> Result<RelocationKindInfo> {
        reld_reloc::loongarch64::relocation_type_from_raw(r_type).ok_or_else(|| {
            error!(
