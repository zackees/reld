...
use reld_reloc::elf::AllowedRange;
...
impl crate::platform::Relaxation for Relaxation {
    ...
    fn rel_info(&self) -> reld_reloc::elf::RelocationKindInfo {
        todo!()
    }
    ...
    fn next_modifier(&self) -> reld_reloc::relaxation::RelocationModifier {
        todo!()
    }
...
impl crate::platform::Arch for MachOAArch64 {
    ...
    fn get_dynamic_relocation_type(
        relocation: reld_reloc::elf::DynamicRelocationKind,
    ...
    fn new_relaxation(
        ...
        relax_deltas: Option<&reld_reloc::relaxation::SectionRelaxDeltas>,
