...
This crate allows the reld linker to be used as a library. The API is currently fairly narrow and is
...
For more details about the reld linker, see the [reld
repository](https://github.com/zackees/reld).
