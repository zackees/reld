...
// Tests that --as-needed shared libraries are NOT activated for weak symbol references. This
// matches the behaviour of GNU ld and lld (mold differs). If fn1 is non-null the lib was
