# Run on Gentoo
#
# docker build --progress=plain -t reld-dev-gentoo . -f docker/gentoo.Dockerfile
# docker run -it reld-dev-gentoo

FROM gentoo/stage3:20251208 AS chef

RUN echo "dev-util/rustup" >> /etc/portage/package.accept_keywords/reld
RUN emerge-webrsync
