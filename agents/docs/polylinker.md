...
| Capability table | **Shipped, initial set.** ELF native-vs-lld capabilities cover LTO, ICF, discard-all, color policy, and Cortex-A53 erratum 843419. Extend this table as new native gaps are routed. |
